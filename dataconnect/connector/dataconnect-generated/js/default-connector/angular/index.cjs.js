const { upsertUserRef, upsertBookRef, upsertReadHistoryRef, deleteReadHistoryRef, booksRef, readHistoryRef } = require('../');
...
exports.injectUpsertReadHistory = function injectUpsertReadHistory(args, injector) {
  return injectDataConnectMutation(upsertReadHistoryRef, args, injector, CallerSdkTypeEnum.GeneratedAngular);
}

exports.injectDeleteReadHistory = function injectDeleteReadHistory(args, injector) {
  return injectDataConnectMutation(deleteReadHistoryRef, args, injector, CallerSdkTypeEnum.GeneratedAngular);
}
