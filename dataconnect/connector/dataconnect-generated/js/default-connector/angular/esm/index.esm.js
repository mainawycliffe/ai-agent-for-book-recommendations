import { upsertUserRef, upsertBookRef, upsertReadHistoryRef, deleteReadHistoryRef, booksRef, readHistoryRef } from '../../';
...
export function injectUpsertReadHistory(args, injector) {
  return injectDataConnectMutation(upsertReadHistoryRef, args, injector, CallerSdkTypeEnum.GeneratedAngular);
}

export function injectDeleteReadHistory(args, injector) {
